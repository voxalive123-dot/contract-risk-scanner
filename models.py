...
class Scan(Base):
    ...
    context_user_role: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)
    context_contract_type: Mapped[Optional[str]] = mapped_column(String(80), nullable=True)
    context_criticality_level: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)
    context_risk_posture: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)
    context_deal_value: Mapped[Optional[str]] = mapped_column(String(80), nullable=True)
    context_industry: Mapped[Optional[str]] = mapped_column(String(120), nullable=True)
    context_jurisdiction: Mapped[Optional[str]] = mapped_column(String(80), nullable=True)
    context_negotiation_leverage: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)
    context_counterparty_tier: Mapped[Optional[str]] = mapped_column(String(80), nullable=True)
    context_data_sensitivity: Mapped[Optional[str]] = mapped_column(String(80), nullable=True)
    context_insurance_coverage: Mapped[Optional[str]] = mapped_column(String(80), nullable=True)
    context_capture_version: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)
...
class AccountPasswordToken(Base):
...
class BillingCustomerReference(Base):
    __tablename__ = "billing_customer_references"
    __table_args__ = (
        UniqueConstraint("provider", "external_customer_id", name="uq_billing_provider_customer"),
    )
...
class Subscription(Base):
    ...
    plan_name: Mapped[str] = mapped_column(String(50), nullable=False, server_default="starter")
    status: Mapped[str] = mapped_column(String(50), nullable=False, server_default="no_subscription")
    current_period_end: Mapped[Optional[datetime]] = mapped_column(DateTime(timezone=True), nullable=True)
...
class AIUsageMeter(Base):
    __tablename__ = "ai_usage_meters"
    __table_args__ = (
        UniqueConstraint("org_id", "period_start", "period_end", name="uq_ai_usage_org_period"),
    )
...
class InternalOperatorAction(Base):
    __tablename__ = "internal_operator_actions"
...
class OwnerEntitlementGrant(Base):
    __tablename__ = "owner_entitlement_grants"
    ...
    granted_plan: Mapped[str] = mapped_column(String(50), nullable=False)
    grant_type: Mapped[str] = mapped_column(String(50), nullable=False, server_default="trial")
    scan_quota_override: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    reason: Mapped[str] = mapped_column(Text, nullable=False)
